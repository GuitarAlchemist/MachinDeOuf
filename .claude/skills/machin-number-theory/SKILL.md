...
## Programmatic Usage
```rust
use machin_number_theory::sieve::sieve_of_eratosthenes;
use machin_number_theory::primality::{is_prime_trial, is_prime_miller_rabin};
use machin_number_theory::modular::{mod_pow, gcd, lcm, mod_inverse};
```

## MCP Tool
Tool name: `machin_number_theory`
