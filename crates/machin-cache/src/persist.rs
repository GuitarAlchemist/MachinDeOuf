...
mod tests {
    ...
    fn test_save_and_load_snapshot() {
        ...
        let tmp = std::env::temp_dir().join("machin_cache_test.snapshot");
    ...
    fn test_snapshot_preserves_ttl() {
        ...
        let tmp = std::env::temp_dir().join("machin_cache_ttl_test.snapshot");
    ...
    fn test_snapshot_info() {
        ...
        let tmp = std::env::temp_dir().join("machin_cache_info_test.snapshot");
        save_snapshot(&cache, &tmp).unwrap();
