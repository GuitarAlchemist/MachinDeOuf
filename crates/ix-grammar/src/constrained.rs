...
//! `name ::= alt1 | alt2 | alt3`).
//! [`GrammarMctsState`] implements `ix_search::mcts::MctsState` so the
//! standard `mcts_search` function can derive sentences from the grammar.

use std::collections::HashMap;
use std::sync::Arc;

use ix_search::mcts::{mcts_search, MctsState};
...
impl EbnfGrammar {
    ...
    ///
    /// ```
    /// use ix_grammar::constrained::EbnfGrammar;
...
///
/// ```
/// use ix_grammar::constrained::{EbnfGrammar, search_derivation};
