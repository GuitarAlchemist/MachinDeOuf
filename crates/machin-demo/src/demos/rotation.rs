...
impl RotationDemo {
    pub fn ui(&mut self, ui: &mut egui::Ui) {
        ui.heading("3D Rotations (machin-rotation)");
    ...
    fn compute_slerp(&mut self) {
        ...
        use machin_rotation::slerp::slerp_array;
    ...
    fn euler_ui(&mut self, ui: &mut egui::Ui) {
        ...
        if machin_rotation::euler::gimbal_lock_check(self.pitch) {
    ...
    fn compute_euler(&mut self) {
        use machin_rotation::euler::{EulerOrder, to_quaternion, from_quaternion, gimbal_lock_check};
