...
impl NumberTheoryDemo {
    pub fn ui(&mut self, ui: &mut egui::Ui) {
        ui.heading("Number Theory (machin-number-theory)");
    ...
    fn ui_prime_sieve(&mut self, ui: &mut egui::Ui) {
        ...
        if ui.button("Run Sieve").clicked() {
            let primes = machin_number_theory::sieve::sieve_of_eratosthenes(self.sieve_limit);
    ...
    fn ui_prime_gaps(&mut self, ui: &mut egui::Ui) {
        ...
        if ui.button("Compute Gaps").clicked() {
            let gaps = machin_number_theory::primes::prime_gaps(self.gaps_limit);
    ...
    fn ui_modular(&mut self, ui: &mut egui::Ui) {
        ...
        if ui.button("Compute mod_pow").clicked() {
            let result =
                machin_number_theory::modular::mod_pow(self.mod_base, self.mod_exp, self.mod_modulus);
    ...
    fn ui_primality(&mut self, ui: &mut egui::Ui) {
        ...
        if ui.button("Test Primality").clicked() {
            let result =
                machin_number_theory::primality::is_prime_miller_rabin(self.primality_input, 10);
