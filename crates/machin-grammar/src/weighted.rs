...
///
/// ```
/// use machin_grammar::weighted::{WeightedRule, bayesian_update};
...
///
/// ```
/// use machin_grammar::weighted::{WeightedRule, softmax};
/// let rules = vec![
...
///
/// ```
/// use machin_grammar::weighted::{WeightedRule, select_weighted};
