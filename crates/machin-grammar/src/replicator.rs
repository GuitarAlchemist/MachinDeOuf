...
///
/// ```
/// use machin_grammar::replicator::{GrammarSpecies, replicator_step};
/// let species = vec![
...
///
/// ```
/// use machin_grammar::replicator::{GrammarSpecies, detect_ess};
/// let species = vec![
...
///
/// ```
/// use machin_grammar::replicator::{GrammarSpecies, simulate};
/// let species = vec![
